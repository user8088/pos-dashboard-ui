...
export default function ExpenseManagementComingSoonModal({ isOpen, onClose }) {
    ...
    <Modal isOpen={isOpen} onClose={onClose} size="lg" motionPreset="slideInBottom">
      ...
      <ModalContent bg={cardBg} borderRadius="24px" maxW="600px">
        <ModalHeader color={textColor} fontSize={{ base: 'xl', md: '2xl' }}>
          We're Making Expense Management Live
        </ModalHeader>
        <ModalCloseButton />
        <ModalBody pb={6}>
          <VStack spacing="24px" textAlign="center" align="center" justify="center" w="100%">
            <VStack spacing="16px" maxW="500px">
              <Text 
                ...
                lineHeight="1.7"
              >
                We're currently deploying the Expense Management feature to production. 
              ...
              >
                ...
                <Text 
                  ...
                  fontWeight="500"
                >
                  Making Expense Management Live...
                </Text>
              </Box>
            </VStack>
          </VStack>
